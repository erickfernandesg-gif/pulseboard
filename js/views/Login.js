    ...
    template: `
        <div class="login-layout">
            <el-card class="login-card">
                ...
                <el-form @submit.prevent="loginWithEmail" :model="form">
                    <el-form-item><el-input v-model="form.email" placeholder="Seu e-mail" size="large" prefix-icon="Message"/></el-form-item>
                    <el-form-item><el-input v-model="form.password" type="password" placeholder="Sua senha" size="large" prefix-icon="Lock" show-password @keyup.enter="loginWithEmail"/></el-form-item>
                    <el-alert v-if="errorMessage" :title="errorMessage" type="error" show-icon :closable="false" style="margin-bottom: 20px;" />
                    <el-form-item><el-button type="primary" class="btn-login" size="large" :loading="loading" @click="loginWithEmail">Entrar</el-button></el-form-item>
                </el-form>
